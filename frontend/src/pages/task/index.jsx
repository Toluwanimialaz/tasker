...
function Task(){
    ...
    useEffect(()=>{
        async function get(){
            try{
                const res=await axios.get("https://tasker-client-beige.vercel.app/api/form/task")
    ...
    async function submitted(index){
        ...
        const response=await fetch("https://tasker-client-beige.vercel.app/api/form/task",{
            method:"POST",
            headers:{
